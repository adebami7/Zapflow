...
export function PricingCard({
  ...
  return (
    <div
    className={`relative bg-white p-6 rounded-lg flex flex-col h-full ${
      isRecommended
        ? "border-2 border-brandPrimary shadow-lg"
  ...
  >
    ...
    >
      ...
      <div className="flex items-center justify-center">
        <span className="text-brandPrimary text-3xl font-bold">
    ...
    {/* Features Section - Ensures it takes up space */}
          ...
          {feature.badge && (
            <span
              className={`
                ...
                ${feature.badge === "On Demand" ? "bg-orange-100 text-orange-600" : ""}
                ${feature.badge === "Live Chat" ? "bg-green-100 text-green-600" : ""}
                ${feature.badge === "24/7 Support" ? "bg-purple-100 text-brandPrimary" : ""}
                ${feature.badge === "New" ? "bg-blue-100 text-blue-600" : ""}
                ${feature.badge === "Turbo" ? "bg-yellow-100 text-yellow-600" : ""}
              `}
            >
              {feature.badge}
            </span>
    ...
    {/* Pricing Summary - Pushes Button to Bottom */}
