...
function Hero() {
  return (
    <section>
      <div
        className="bg-cover bg-center py-[70px] h-[640px]"
        ...
        <div className="max-w-[1296px] mx-auto flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center gap-3">
              <Button className="h-[46px] bg-[#0cc763]">
                View Demos
                <Eye size={14} color="#ffffff" />
              </Button>
              <Button className="h-[46px] bg-[#ff5a29e6]">
                Learn More
                <ArrowRight size={14} color="#ffffff" />
              </Button>
            </div>
          </div>
          <img src={Main} alt="hero-main" />
        </div>
      </div>

      <div className="pt-[48px] pb-[70px] bg-[#f5f6fa]">
